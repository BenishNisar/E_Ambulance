...
<!-- Banners -->
<section id="banner" class="banner-section" style="margin-top: 20px;">
  <div class="container">
      ...
      <div class="row">
        <div class="col-md-5 col-md-push-7">
          <div class="banner_content">
           ...
           <a href="book_now.php" class="btn">BOOK NOW<span class="angle_arrow"><i class="fa fa-angle-right" aria-hidden="true"></i></span></a> </div>
        </div>
      </div>
    </div>
  </div>
